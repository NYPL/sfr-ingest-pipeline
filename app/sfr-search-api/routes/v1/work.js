...
const v1Work = (app) => {
  const respond = (res, _resp, params) => {
    ...
    if (respLen > 1) return handleError(res, new ElasticSearchError('Returned multiple records, identifier lacks specificity'))
  ...
  app.get('/api/v0.1/sfr/work', (req, res) => {
